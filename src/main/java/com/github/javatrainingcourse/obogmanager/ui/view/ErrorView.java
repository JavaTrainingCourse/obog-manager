...
public class ErrorView extends Wrapper implements View {
    ...
    public void enter(ViewChangeListener.ViewChangeEvent event) {
        var errorLabel = new Label("エラーが発生しました。");
        ...
        var paramThrowable = (Throwable) session.getAttribute(PARAM_THROWABLE);
        ...
        if (paramThrowable instanceof AuthenticationException) {
            var loginButton = new Button("ログイン", click -> getUI().getNavigator().navigateTo(LoginView.VIEW_NAME));
